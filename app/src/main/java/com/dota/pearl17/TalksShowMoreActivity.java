...
public class TalksShowMoreActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_talks_show_more);
...
//        Log.v("clubEvents", clubEvents.toString());
    ...
    public class adapter extends RecyclerView.Adapter<adapter.Item> {
        ...
        public Item onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View row = inflater.inflate(R.layout.talk_row, parent, false);
            return new Item(row);
        }
